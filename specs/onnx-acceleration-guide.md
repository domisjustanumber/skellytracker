...
| ------------------------- | ------------------------- | ----------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| **Linux / Windows**       | **AMD**                   | AMD Instinct / Radeon GPU (MI200–MI300, RX 7000+)                                   | `MIGraphXExecutionProvider`<br><br>  <br><br>_(Note: `ROCmEP` is deprecated)_                             | **FP16** or **INT8 (Static QDQ)**                       | **A-Tier (High)**<br><br>Optimized graph compilation for AMD ROCm stack.                                                                      |
| **Linux / Windows**       | **Apple**                 | ARM CPU (Apple Silicon, Ampere)                                                     | `XNNPACKExecutionProvider` _(or default CPU)_                                                             | **INT8 (Static QDQ)** or **FP32**                       | **D-Tier (Low)**<br><br>Lightweight execution tailored for edge CPUs via ARM NEON.                                                            |
...
| **Linux / Windows**       | **Intel**                 | Intel Arc / Iris Xe GPU (Discrete & iGPU)                                           | `OpenVINOExecutionProvider`                                                                               | **FP16** or **INT8 (Static QDQ)**                       | **A-Tier to B-Tier**<br><br>Accelerated via Intel Xe matrix extension pipelines.                                                              |
...
| **Linux / Windows**       | **Qualcomm**              | Qualcomm Snapdragon NPU / Mobile Platform                                           | `QNNExecutionProvider`                                                                                    | **INT8 (Static QDQ)** or **FP16**                       | **A-Tier (High)**<br><br>Direct offload to Qualcomm Hexagon NPU hardware pipelines.                                                           |

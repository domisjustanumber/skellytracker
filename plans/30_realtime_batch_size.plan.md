...
- Sidecar `onnx.batch_artifacts` / `batching.batch_conversion` integration ? [60_sidecar_batch_conversion.plan.md](60_sidecar_batch_conversion.plan.md) (spec) and [50_yolo26_nano_detection.plan.md](50_yolo26_nano_detection.plan.md) (runtime)
...
flowchart LR
  ...
  p40[40_detector_sidecar_spec]
  p60[60_sidecar_batch_conversion]
  p50[50_yolo26_nano_detection]
  p70[70_pose_estimator_sidecar_spec]
  p10 --> p20
  p20 --> p30
  p30 --> p40
  p40 --> p60
...
| **40** | [40_detector_sidecar_spec.plan.md](40_detector_sidecar_spec.plan.md) | Detector Sidecar Spec (`schema_version`, `onnx.batch_artifacts`, `resize.interpolation`) |
| **60** | [60_sidecar_batch_conversion.plan.md](60_sidecar_batch_conversion.plan.md) | `batching.batch_conversion` spec before YOLO26 `model_batch_convert()` |
| **50** | [50_yolo26_nano_detection.plan.md](50_yolo26_nano_detection.plan.md) | Fixed-batch detector ? assumes plans 10?60 complete |
| **70** | [70_pose_estimator_sidecar_spec.plan.md](70_pose_estimator_sidecar_spec.plan.md) | Pose estimator sidecar (RTMW, RTMW3D, RTMO, YOLO26 pose); follows plan 40 |
...
- [40_detector_sidecar_spec.plan.md](40_detector_sidecar_spec.plan.md) ? **next in sequence**; Detector Sidecar Spec before plan 60 batch conversion.
- [60_sidecar_batch_conversion.plan.md](60_sidecar_batch_conversion.plan.md) ? `batching.batch_conversion` spec before YOLO26 catalog.
